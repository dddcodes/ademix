...
const article = [
    ...
    {
    title: "Independencia, soberanía y nación",
    asign: "his",
    unity: 1,
    mini: "link de miniatura",
    grade: 9,
    pdf: "https://drive.google.com/file/d/1wT5yefjpcYUgQif8EtR7tgSAAmjBcDOr/preview",
    audio: "link del audio en google drive",
    quiz: [{
        question: "Es la capacidad de actuar, hacer y elegir sin intervención o tutela ajena. Es lo opuesto a la dependencia y aplica tanto a personas como a instituciones formales, como el Estado.",
        ...
        {
        question: "Es la autoridad más elevada en la cual reside el poder político y público de un pueblo, una nación o un Estado sobre su territorio y sus habitantes. ",
        answer: "Soberanía",
        incorrectAnswer: [
            "Independencia", 
            "Nación",
        ...
        {
        question: "Pueblo o país, en el cual habitan personas que comparten idioma, raza y costumbres. ",
        answer: "Nación",
        incorrectAnswer: [
            "Soberanía",
            "Independencia",	
        ...
        {
        question: "Querían la independencia, ya que no deseaban ser gobernados por franceses y proponían un gobierno formado por los habitantes de la Nueva España.", 
        answer: "Insurgentes",
        incorrectAnswer:[             
            "Federalistas", 
            "Centralistas",
        ...
        {
        question: "Partidario de disminuir o limitar los poderes centrales del Estado.",
        answer: "Federalismo",
        incorrectAnswer: [
            "Centralismo",
            "Liberales", 
        ...
        {
        question: "¿Cuáles son los tres poderes que se establecieron en 1824 con el triunfo de los federalistas como forma de gobierno?",
        answer: "Ejecutivo, Legislativo y Judicial",
        incorrectAnswer: [
            "Ejecutivo y Judicial",
            "Ejecutivo, Legistativo y Equitativo",
            "Federativo, Ejecutivo y Judicial"       
        ]},
        {
        question: "Buscaban una sociedad igualitaria sin diferencias de ningún orden. Sin privilegios ni fueros para el clero y el ejército. ",
        answer: "Liberales",
        incorrectAnswer: [
            "Conservadores",
            "Rebeliones",
        ...
        {
        question: "Apoyaron a los fueros o privilegios del clero y del ejército; deseaban mantener sus propios privilegios",
    ...
    {
    title: "Elaborar informes de experimento",
    asign: "esp",
    unity: 3,
    mini: "link de miniatura",
    grade: 9,
    pdf: "https://docs.google.com/file/d/13XFHNpZYZccRqyaW8nyf6g9vnQL2JTWK82kbFgb2tg8/preview",
    audio: "link del audio en google drive",
    quiz: [
    {
    question: "¿Qué es un informe de experimento?",
    answer: "Documento escrito que tiene como objetivo registrar los pasos o las observaciones que se hayan realizado durante la elaboración",
    incorrectAnswer: [
    "Son pasos donde dibujas para la elaboración de un producto",
    "Son documentos hechos a mano para todo público",
    "Son documentos para ayudar a personas mayores con su vista"
    ]},
    {
    question: "¿Son algunos de los recursos que apoyan el contenido de un informe científico?",
    answer: "Las gráficas y tablas",
    incorrectAnswer: [
    "listas",
    ...
    {
    question: "¿Qué es una gráfica?",
    answer: "Es una representación de los datos relacionados entre sí, de manera que se identifique el número de a veces que se repiten",
    incorrectAnswer: [
    "Explica la hipótesis planteada en un principio se comprobó o no",
    "Se describe paso a paso tanto el procedimiento que se siguió en los resultados",
    "Se presenta el tema y se orienta al lector"
    ]},
    {
    question: "¿Qué es una tabla?",
    answer: "Es un recurso sintetizado y ordena la información en filas y columnas relacionando conceptos y cifras",
    incorrectAnswer: [
    "Sirven para representar una secuencia o las fases de un proceso",
    "Explica de forma detallada y ordenada como los objetivos, lugares, personas o procesos",
    "Es una representación gráfica constituida por ilustraciones, datos y textos que comunican de forma simple los resultados del estudio"
    ]},
    {
    question: "¿Qué son diagramas?",
    answer: "Sirven para representar una secuencia o las fases de un proceso",
    incorrectAnswer: [
    "Identifica de forma detallada y ordenada como los objetivos, lugares, personas o procesos",
    "Es un recurso sintetizado y ordena la información en filas y columnas relacionando conceptos y cifras",
    "Representa datos relacionados entre sí"
    ]},
    {
    question: "¿Qué es una hipótesis?",
    answer: "Posible respuesta del investigador para comprender o solucionar el problema que aborda",
    incorrectAnswer: [
    "Identificar qué proceso vamos a describir y cuál es su finalidad",
    "Es una representación de los datos relacionados entre si",
    "Explica la hipótesis planteada en un principio se comprobó o no"
    ]},
    {
    question: "El propósito del experimento normalmente se describe en esta sección",
    answer: "Introduccion",
    incorrectAnswer: [
    "Mteriales",
    "Propositos",
    ...
    {
    question: "Se mencionan los pasos que se llevaron a cabo y los instrumentos que se plantearon",
    answer: "Materiales y métodos",
    incorrectAnswer: [
    "Introducción",
    "Propositos",
    "Resultados"
    ...
    {
    question: "Muestra los pasos que se llevaron a cabo para la realización del experimento",
    ...
    mini: "link de miniatura",
    grade: 9,
    pdf: "https://docs.google.com/file/d/1uxFsovYJCWKr6GQgqHPgpKcTNPFguQv1jAj3xL_wUs4/preview",
    audio: "link del audio en google drive",    
    quiz: [{
        question: "Son documentos -impresos o electrónicos- emitidos por instituciones que ofrecen servicios a la comunidad. Tienen la función de registrar, de manera clara, ordenada y sistematizada, los datos de las personas que solicitan los servicios.",
        answer: "Formularios",
        incorrectAnswer: [
            "Encuestas",
            "Carta poder",
        ...
        {
        question: "Se usan para asegurarse de que es una persona y no un programa quien llena el formulario electrónico. ",
        answer: "códigos CAPTCHA",
        incorrectAnswer: [
            "códigos QR", 
            "Código de barras",
            "Código fuente",
        ...
        {
        question: "Es uno de los documentos oficiales que sirven para probar la identidad personal, no sólo de México, sino del extranjero.",
        answer: "Pasaporte",
        incorrectAnswer: [
            "Acta de nacimiento",
            "Cartilla de salud",	
        ...
        {
        question: "Tiene como finalidad dar constancia del nacimiento de cada persona en el territorio de nuestro país y, por ello, obtiene la nacionalidad mexicana.", 
        answer: "Acta de nacimiento",
        incorrectAnswer:[             
            "CURP", 
            "Pasaporte",
            "RFC"
        ...
        {
        question: "Los formularios presentan una serie de recuadros, llamados ________o_________, en los que se deben registrar los datos solicitados.",
        answer: "Ventanas o campos",
        incorrectAnswer: [
            "recuadros o espacios",
            "Celdas ", 
            "Celdas o recuadros"
        ]}]   
    }
